"""
Processes the ambiguous word-level predictions from DeepSolo only.
...
if __name__ == "__main__":
    ...
    from outputs import\
        read_pickle_queue,\
        convert_deepsolo_outputs_to_gdf,\
    ...
    try:
        ...
        predictions, errors = convert_deepsolo_outputs_to_gdf(
        ...
        for ambiguous_meta_fn in ambiguous_meta_filename_iter:
            ...
            processed_preds["wordid"] = [*range(len(processed_preds))]
