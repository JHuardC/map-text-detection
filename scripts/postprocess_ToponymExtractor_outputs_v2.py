...
import progressbar
from numpy import ndarray, pad as pad_array, concatenate as concat_array
...
if __name__ == "__main__":
    ...
    from outputs import ProcessToponymExtractorPredictionsV2
    ...
    parser.add_argument(
        ...
        action = "store",
        type = str,
        metavar = "to/save/ambiguous/gcp.ext",
        default = None,
        dest = "ctrl_out",
        help =\
    ...
    try:
        ...
        post_processor = ProcessToponymExtractorPredictionsV2(
            ctrl_points = control_points,
            tiff_dir = tiff_dir,
            **config["extractor_init_kwargs"]
        )
        ...
        for tiff_fp in tiff_files:
            ...
            if len((images := outputs[2]["image"])):
                ...
                ambiguous_img = pad_array(
                    ...
                    pad_width = ((0, 0), (0, pad)),
                    mode = "constant",
                    constant_values = config["pad_fill"]
                )
                pad = (
                    pad_h
                ...
                ambiguous_img, img_iter, clique_img, meta_strip =\
                    build_image_strip(
                        ...
                        pad_w = pad_w,
                        max_w = max_w,
                        pad_fill_value = config["pad_fill"]
                    )
